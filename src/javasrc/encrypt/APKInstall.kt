...
internal object APKInstall {
    private val MD5_RES = "6A BB 0D 77 7F B9 63 59 21 51 D4 B6 DA B7 98 F9 "
    private val Win_SRC = ".\\bin\\adb install -r .\\bin.\\disair-release.apk"
    @JvmStatic
    fun main(args: Array<String>) {
        println("DSAir 2019-1-22测试使用Android安装包 [ V1.0 维护:LiFan ]")
        val checkMD5 = MD5.stringMD5(".\\bin\\disair-release.apk")
        if (MD5_RES != checkMD5){
